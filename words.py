...
class HumanPlayer(Player):
    ...
    def get_move(self, game):
        ...
        while not valid_square:
            square = input(self.letter + '\'s turn. Impact move (0-8):' )
            try:
                val = int(square)
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        if state.current_winner == other_player:
            #we should return position and score because we have to keep track of both postion and score
            # for minimax to work
        ...
        for possible_move in state.available_moves():
            ...
            #step 2: recurse using maximize to simulate a game after making that move
